const Banner = () => {
  return (
    <div className="w-full bg-[#0c3c78] text-white">
      {/* TOP HEADING */}
      <div className="w-full flex flex-col sm:flex-row items-center justify-between px-4 py-2 sm:py-4 text-center bg-[#0c3c78]">
      ...
      >
        {/* Title box */}
        <div className="bg-blue-900 bg-opacity-70 px-2 py-2 sm:py-4 rounded-lg text-center w-full sm:w-[90%] md:w-[70%] lg:w-[60%] xl:w-[50%]">
          <h2 className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-bold">
            MALKANI HOSPITAL OF ELECTROHOMEOPATHY{" "}
            <br className="hidden sm:block" />& RESEARCH CENTRE
          </h2>

          <p className="mt-2 text-sm sm:text-md font-semibold">
      ...
      <div className="relative bg-gradient-to-r from-red-600 to-red-500 p-2 sm:p-3 text-center">
